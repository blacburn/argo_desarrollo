...
class registrarForm {
    ...
    function miForm() {
        ...
        $cadenaSqlevento = $this->miSql->getCadenaSql('obtenerInfoAuditoria', $_REQUEST ['id']);
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "CONSULTAR AUDITORÍA CONTRATO <br>" . $_REQUEST['mensaje_titulo'] . " | Responsable : " . $usuario[0]['nombre'] . " " . $usuario[0]['apellido'];
