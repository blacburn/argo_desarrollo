...
class registrarForm {
    ...
    function miForm() {
        ...
        $cadenaSqlevento = $this->miSql->getCadenaSql('obtenerInfoAuditoriaError', $_REQUEST ['id']);
        ...
        if($usuarioRol){
            ...
            $_REQUEST ['tipo_contrato'] = $evento[0]['tipo_contrato'];
            $_REQUEST ['estado_contrato'] = $evento[0]['estado_contrato'];        
            $_REQUEST ['query'] = $mensaje_query;
            $_REQUEST ['host'] = $evento[0]['host'];
            $_REQUEST ['id_responsable'] = $evento[0]['id_usuario']; 
            $_REQUEST ['justificacion'] = $evento[0]['justificacion'];
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "CONSULTAR AUDITORÍA ERROR CONTRATO <br>" . $_REQUEST['mensaje_titulo'] . " | Responsable : " . $usuario[0]['nombre'] . " " . $usuario[0]['apellido'];
