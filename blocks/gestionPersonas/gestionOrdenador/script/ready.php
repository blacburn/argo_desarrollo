...
$("#gestionOrdenador").validationEngine({
...
$(function() {
$("#gestionOrdenador").submit(function() {
$resultado=$("#gestionOrdenador").validationEngine("validate");
if ($resultado) {
return true;
}
return false;
...
$("#<?php echo $this->campoSeguro('rol') ?>").width(420);
$("#<?php echo $this->campoSeguro('rol') ?>").select2();


$("#<?php echo $this->campoSeguro('pais') ?>").width(420);
$("#<?php echo $this->campoSeguro('pais') ?>").select2();
$("#<?php echo $this->campoSeguro('departamento') ?>").width(420);
$("#<?php echo $this->campoSeguro('departamento') ?>").select2();
$("#<?php echo $this->campoSeguro('ciudad') ?>").width(420);
