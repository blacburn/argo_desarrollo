...
class Funcion {
    ...
    function RegistrarSupervisor() {
        include_once ($this->ruta . "funcion/registrarSupervisor.php");
    }

    function RegistrarOrdenador() {
        include_once ($this->ruta . "funcion/registrarOrdenador.php");
    }

    function ModificarSupervisor() {
        include_once ($this->ruta . "funcion/modificarSupervisor.php");
    }

    function ModificarOrdenador() {
        include_once ($this->ruta . "funcion/modificarOrdenador.php");
    }
        ...
        if (isset($_REQUEST ['procesarAjax'])) {
            ...
            switch ($_REQUEST ['opcion']) {
                ...
                case 'registrarOrdenador' :
                    $this->RegistrarOrdenador();
                    break;    

                case 'modificarSupervisor' :
                    $this->ModificarSupervisor();
                    break;

                case 'modificarOrdenador' :
                    $this->ModificarOrdenador();
                    break;    
            }
        }
    }
