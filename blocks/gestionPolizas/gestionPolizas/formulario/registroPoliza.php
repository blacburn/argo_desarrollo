...
class registrarForm {
    ...
    function miForm() {
        ...
        $cadenaSql = $this->miSql->getCadenaSql('Consultar_Info_Suscripcion', $datos);

        $fecha_suscripcion = $esteRecursoDB->ejecutarAcceso($cadenaSql, "busqueda");

        $esteCampo = 'fecha_suscripcion_validacion';
        ...
        $atributos ['marco'] = true;
        $atributos ["etiqueta"] = "";
        $atributos ['valor'] = $fecha_suscripcion[0]['fecha_suscripcion'];
        $atributos = array_merge($atributos, $atributosGlobales);
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Registra Poliza " . $_REQUEST['mensaje_titulo'];
        ...
        $atributos ["estilo"] = "jqueryui";
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Registro Datos Basicos de la Poliza";
        echo $this->miFormulario->marcoAgrupacion('inicio', $atributos);
        ...
        $valorCodificado .= "&opcion=registrarPoliza";
