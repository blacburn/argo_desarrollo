...
require_once("../clase/encriptar.class.php");
	...
	$enlacePagos=$indiceAcademico.$variable;
        ...
        $identificacion = $_SESSION ['usuario_login'];
        $tipo = 30;
        $indiceArkaInventarios = $configuracion ["host_inventario"] . "/argo/index.php?";
        $tokenCondor = "0xel0t1lwvXl1FO7";
        $opcion = "data=";
        $variable = "actionBloque=funcionarioElemento";
        $variable .= "&pagina=gestionActasInicio";
        $variable .= "&bloqueGrupo=gestionActas";
        $variable .= "&bloque=gestionActasInicio";
