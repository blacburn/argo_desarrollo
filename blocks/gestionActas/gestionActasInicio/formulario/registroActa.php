...
//            $esteCampo = "AgrupacionInventario";
//            $atributos ['id'] = $esteCampo;
//            $atributos ["estilo"] = "jqueryui";
//            $atributos ['tipoEtiqueta'] = 'inicio';
//            $atributos ['leyenda'] = "Inventario Asignado al Contratista:  CC ". $contratista[0]['num_documento'] ." - " . $contratista[0]['nom_proveedor'];
//            echo $this->miFormulario->agrupacion('inicio', $atributos);
//            {
//
//
...
//
//
//                    echo '<table id="tablaFP2" class="table1" width="100%" >
//                        <!-- Cabecera de la tabla -->
//                        <thead>
//                            <tr>
//                            <th width="2%" ><center>#</center></th>
//                            <th width="5%" ><center>TIPO BIEN</center></th>
//                            <th width="8%"><center>PLACA</center></th>
//                            <th width="35%"><center>DESCRIPCIÓN</center></th>
//                            <th width="15%" ><center>SEDE</center></th>
//                            <th width="20%" ><center>DEPENDENCIA</center></th>
//                            <th width="15%" ><center>ESTADO DEL BIEN</center></th>
//                            </tr>
//                    </thead>
//                    <tbody>';
//
...
//                        echo '<tr>'
//                        . '<td>' . ($i + 1) . '</td>'
//                        . '<td>' . $inventario[$i]['tipo_bien'] . '</td>'
//                        . '<td>' . $inventario[$i]['placa'] . '</td>'
//                        . '<td>' . $inventario[$i]['descripcion'] . '</td>'
//                        . '<td>' . $inventario[$i]['sede'] . '</td>'
//                        . '<td>' . $inventario[$i]['dependencia'] . '</td>'
//                        . '<td>ACTIVO</td>'
//                        . '</tr>';
//                    }
//                    echo '</tbody></table>';
...
//                    $atributos ['tipo'] = 'warning';
//                    $atributos ['estilo'] = 'textoCentrar';
//                    $atributos ['mensaje'] = "El contratista no cuenta con inventario asignado.";
//
//                    $tab ++;
//
//                    // Aplica atributos globales al control
