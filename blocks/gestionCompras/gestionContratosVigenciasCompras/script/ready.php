...
$("#gestionContratosVigenciasCompras").validationEngine({
...
$(function() {
$("#gestionContratosVigenciasCompras").submit(function() {
...
$("#<?php echo $this->campoSeguro('clase_contrato') ?>").width(320);
...
$("#<?php echo $this->campoSeguro('numero_contrato') ?>").width(250);
$("#<?php echo $this->campoSeguro('numero_contrato') ?>").select2();

$("#<?php echo $this->campoSeguro('estado') ?>").width(250);
