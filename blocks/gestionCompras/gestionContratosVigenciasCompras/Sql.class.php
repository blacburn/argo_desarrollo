    ...
    function getCadenaSql($tipo, $variable = "") {
        ...
        switch ($tipo) {
            ...
            case 'buscar_contrato3' :
                ...
                $cadenaSql .= " AND (ec.id != 1 AND ec.id != 3) ";
            ...
            case 'buscar_contrato2' :
                ...
                $cadenaSql .= " AND cg.numero_contrato = ce.numero_contrato and cg.vigencia = ce.vigencia and ce.estado = ec.id and cg.vigencia = " . $variable['vigencia_curso'] . " ";
                $cadenaSql .= " AND ce.fecha_registro = (SELECT MAX(cee.fecha_registro) from contrato_estado cee where cg.numero_contrato = cee.numero_contrato and  cg.vigencia = cee.vigencia) ";
                $cadenaSql .= " AND (ec.id != 1 AND ec.id != 3) AND tpc.id_grupo_tipo_contrato = 1";
                $cadenaSql .= " ORDER BY cs.fecha_suscripcion ASC;";
                break;
            ...
            case "consultarOrdenGeneral" :
                ...
                $cadenaSql = "SELECT DISTINCT o.id_orden, p.descripcion, o.numero_contrato, "
                        . "o.vigencia, cs.fecha_registro, cg.contratista  as proveedor,o.tipo_orden, ec.id as estate, "
                ...
                $cadenaSql .= "AND cg.estado = 'true' "
                        . "AND cg.clase_contratista is not null ";       
                if($variable ['estado'] != ''){
                    $cadenaSql .= " AND ec.id = ". $variable['estado'] . " ";
                }
            ...
            case "consultarContratosGeneral" :
                ...
                $cadenaSql .= "AND cg.numero_contrato = ce.numero_contrato and cg.vigencia = ce.vigencia and ce.estado = ec.id ";
                $cadenaSql .= "AND ce.fecha_registro = (SELECT MAX(cee.fecha_registro) from contrato_estado cee where cg.numero_contrato = cee.numero_contrato and  cg.vigencia = cee.vigencia) ";
                $cadenaSql .= "AND cg.unidad_ejecutora = " . $variable ['unidad_ejecutora'] . "  and tpc.id_grupo_tipo_contrato = 1 ";
                $cadenaSql .= "AND cg.estado = 'true' AND cg.vigencia = " . $variable['vigencia'] . "  AND cg.clase_contratista is not null ";
                if($variable ['estado'] != ''){
                    $cadenaSql .= " AND ec.id = ". $variable['estado'] . " ";
                }
                if ($variable ['clase_contrato'] != '') {
		...
		$cadenaSql = " 	SELECT ai.fecha_inicio, ";
            ...
            case 'buscar_contrato' :
                ...
                $cadenaSql .= " AND ce.fecha_registro = (SELECT MAX(cee.fecha_registro) from contrato_estado cee where cg.numero_contrato = cee.numero_contrato and  cg.vigencia = cee.vigencia) ";
                $cadenaSql .= " AND ec.id = 4 AND (cast(cs.numero_contrato_suscrito as text) LIKE '%" . $variable['parametro'] . "%' ";
