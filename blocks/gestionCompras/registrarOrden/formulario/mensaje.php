...
class registrarForm {
	...
	$conexionAgora = "agora";
        ...
        echo $this->miFormulario->formulario($atributos); {
            ...
            echo $this->miFormulario->marcoAgrupacion('inicio', $atributos); {
                ...
                if ($_REQUEST ['mensaje'] == 'ErrorRegistroSociedadTemporal') {
                    ...
                    $mensaje = "<h3>NO SE REALIZO EL REGISTRO DE LA ORDEN. <br> ERROR AL REGISTRAR LA INFORMACIÓN DE LAS SOCIEDAD TEMPORAL.</h3>";
		...
		if (isset($_REQUEST ['mensaje']) && $_REQUEST ['mensaje'] == 'noInsertoContratoDuplicado') {
                    ...
                    $mensaje = "<h4>Error al Registrar Orden.<br><br><br>La Orden ya ha sido registrada anteriormente con los mismos datos<br><br> Orden con vigencia: " . $_REQUEST['vigencia'] . 			    "<br>Contratista: " . $infoTipoPersona[0][0] . "<br><br>Para mayor informacion del registro por favor consultar el modulo de Consultar y modificar Orden mediante los respectivos filtros de 	 	    busqueda e ingresar en modificar orden con el fin de visualizar todos los datos registrados para la orden en mencion.</h4>";
                ...
                if (isset($_REQUEST ['mensaje']) && $_REQUEST ['mensaje'] == 'confirma') {
                    ...
                    $mensaje = "<h3>" . $_REQUEST ['mensaje_titulo'] . "</h3>";
