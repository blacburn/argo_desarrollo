...
class registrarForm {
    ...
    function miForm() {
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Consulta de Ordenes Suscritas";
        ...
        if ($Orden) {
            ...
            echo "<thead>
                             <tr>
                                ...
                                <th><center>Modificar Orden</center></th>
            ...
            for ($i = 0; $i < count($Orden); $i ++) {
                ...
                $variable_mod = "pagina=consultaOrden"; // pendiente la pagina para modificar parametro
                $variable_mod .= "&opcion=modificarOrden";
                $variable_mod .= "&numerocontrato=" . $Orden [$i] ['numero_contrato'];
                $variable_mod .= "&numero_contrato_suscrito=" . $Orden [$i] ['numero_contrato_suscrito'];
                $variable_mod .= "&id_orden=" . $Orden [$i] ['id_orden'];
                $variable_mod .= "&vigencia=" . $Orden [$i] ['vigencia'];
                $variable_mod .= "&id_contratista=" . $Orden [$i] ['proveedor'];
                $variable_mod .= "&arreglo=" . $arreglo;
                $variable_mod .= "&usuario=" . $_REQUEST ['usuario'];
                $variable_mod .= "&mensaje_titulo= --> Contrato: " . $Orden [$i] ['tipo_contrato'] . " | VIGENCIA: " . $Orden [$i] ['vigencia'] . " | NÚMERO CONTRATO : " . $Orden [$i] ['numero_contrato_suscrito'];
                /*
