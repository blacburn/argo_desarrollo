...
class registrarForm {
    ...
    function miForm() {
        ...
        echo $this->miFormulario->formulario($atributos);
        {
            ...
            $atributos ['tipoEtiqueta'] = 'inicio';
            $atributos ["leyenda"] = "CONSULTAR  " . $_REQUEST ['mensaje_titulo'] . "| Elaborador por : " . $usuario[0]['nombre'] . " " . $usuario[0]['apellido'];
            ...
            unset($atributos);
            {
                ...
                } elseif (isset($_REQUEST['otherBlock'])) {
                    $variable = "pagina=gestionContratosVigenciasCompras";
                    $variable .= "&opcion=ConsultarContratos";
                    $variable .= "&vigencia=" . $arreglo['vigencia'];
                    $variable .= "&numero_contrato=" . $_REQUEST['numero_contrato_suscrito'];
...
//          
            ...
            echo "<input id='amparosOculto' name='amparosOculto' type='hidden' value='" . json_encode($amparosParametros) . "'>";
                ...
                if (isset($_REQUEST['ordenATC']) && $_REQUEST['ordenATC'] == "true") {
                    ...
                    $host = $this->miConfigurador->getVariableConfiguracion("host") . $this->miConfigurador->getVariableConfiguracion("site") . "/blocks/gestionCompras/novedadOrden/registrarNovedadOrden/archivoSoporte/";
                    $hostLiquidados = $this->miConfigurador->getVariableConfiguracion("host") . $this->miConfigurador->getVariableConfiguracion("site") . "/blocks/gestionCompras/gestionOrdenesATC/archivoSoporte/";


                    if ($_REQUEST['estado'] == '7') {
                        $consultaOrdenATC = $this->miSql->getCadenaSql("info_orden_Cancelada", $datosOrden);
                        $infoCancelada = $DBContractual->ejecutarAcceso($consultaOrdenATC, "busqueda");
                        $mensaje = "Orden Cancelada en la fecha:" . $infoCancelada[0]['fecha_cancelacion'] . "<br>";
                        ...
                        $consultaOrdenATC = $this->miSql->getCadenaSql("info_orden_Anulada", $datosOrden);
                        $infoAnulada = $DBContractual->ejecutarAcceso($consultaOrdenATC, "busqueda");
                        $mensaje = "Orden Anulada en la fecha: " . $infoAnulada[0]['fecha_registro'] . "<br>";
                        ...
                        $consultaOrdenATC = $this->miSql->getCadenaSql("info_orden_terminada_anticipada", $datosOrden);
                        $infoTerminadoAnticipado = $DBContractual->ejecutarAcceso($consultaOrdenATC, "busqueda");
                        ...
                        $consultaOrdenATC = $this->miSql->getCadenaSql("info_contrato_liquidado", $datosOrden);
                        $infoLiquidado = $DBContractual->ejecutarAcceso($consultaOrdenATC, "busqueda");
                        ...
                        $consultaOrdenATC = $this->miSql->getCadenaSql("info_orden_termminada", $datosOrden);
                        $infoTerminada = $DBContractual->ejecutarAcceso($consultaOrdenATC, "busqueda");
                        $mensaje = "Orden Finalizada: " . $infoTerminada[0]['fecha_registro'] . "<br>";
