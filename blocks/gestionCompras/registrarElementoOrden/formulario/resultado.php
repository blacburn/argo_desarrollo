        ...
        if ($Orden) {
            ...
            echo "<thead>
            			...
            			<th>Identificación<br>Nombre Contratista</th>
                                ...
                                <th>Estado</th>
                                <th>Cargar Elementos<br>ó Servicos</th>
            ...
            for ($i = 0; $i < count($Orden); $i ++) {
                ...
                $variable .= "&mensaje_titulo=" . $Orden [$i] ['tipo_contrato'] . " <br>CONSECUTIVO ELABORACIÓN -- VIGENCIA : " . $Orden [$i] ['numero_contrato'] . " -- " . $Orden [$i] ['vigencia'];
                $variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url($variable, $directorio);
