...
class registrarForm {
    ...
    function miForm() {
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Contratos por Vigencia";
        ...
        if ($contratos) {
            ...
            echo "<thead>
                             <tr>
                                <th rowspan='2'><center>Vigencia</center></th>
                                <th rowspan='2'><center>Número Contrato</center></th>            
                                <th rowspan='2'><center>Tipo Contrato</center></th>            
                                <th rowspan='2'><center>Contratista</center></th>
                                <th rowspan='2'><center>Fecha Registro</center></th>
                                <th rowspan='2'><center>Fecha Aprobado</center></th>
                                <th rowspan='2'><center>Estado</center></th>
                                <th rowspan='2'><center>Consultar Contrato</center></th>
                                <th rowspan='2'><center>Documento<input type='text' name='fuentedocumento' placeholder='Tamaño Fuente' id='fuentedocumento'></th>
                                <th colspan='2'><center>Acta de Inicio</center></th>
            ...
            foreach ($contratos as $valor) {
                ...
                $mostrarHtml .="
                    ...
                    $mostrarHtml .="
                    <td><center>" . $contratosAct [0]['fecha_inicio'] . "</center></td>";

                    $mostrarHtml .="
                    <td><center>" . $contratosAct [0]['fecha_final_contrato'] . "</center></td>";
