...
class registrarForm {
    ...
    function miForm() {
        ...
        if (isset($_REQUEST['idnovedadModificacion'])) {
            ...
            $_REQUEST['mensaje_titulo'] = "Novedad de Modificacion Contractual, Numero de Contrato " . $_REQUEST['numero_contrato_suscrito'] . " | " . $_REQUEST['vigencia'] . ""
...
//         
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Actualizar Contrato --> " . $_REQUEST['mensaje_titulo'] . "| Elaborador por : " . $usuario[0]['nombre'] . " " . $usuario[0]['apellido'];
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------               
                ...
                echo "<h3>Información de Contrato</h3>
                    ...
                    $atributos ['cadena_sql'] = $this->miSql->getCadenaSql("tipo_compromisoContrato");
                ...
                echo "<h3>Garantía y Mecanismos de Cobertura del Riesgo</h3><section>";
                  ...
                  echo '<label for="vigencia">Número de Amparos Registrados : </label>' .
                              '<input id=numR class=\"pull-center btn btn-default\" type="button"  value="'.$contadorArrend . '"/>' .
                               '<br><br>' .
...
//
                ...
                if (isset($_REQUEST['clase_contratista'])) {
                    ...
                    } elseif ($_REQUEST['clase_contratista'] == '32') {
