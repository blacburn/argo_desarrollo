...
<tr>
        ...
        $cadenaSql = $this->miSql->getCadenaSql('consultaPlantilla', array('tipo_contrato' => $contrato['tipo_contrato'], 'tipo_plantilla' => 'plantillaObra',  'fecha_vigencia' => $contrato['fecha_registro']));
     ...
     /*   $cadenaSql = $this->miSql->getCadenaSql('consultaPlantilla', array('tipo_contrato' => $contrato['tipo_contrato'], 'tipo_plantilla' => 'plantillaArrendamiento'));
        ...
        $textos = array(0 => $contenidoPaginaEncabezado, 1 => $contenidoPagina, 2 => $contenidoPiePagina, 3 => $estilos, 4 => "Contrato Obra" . $datosContrato[0] . '-' . $datosContrato[1]);
