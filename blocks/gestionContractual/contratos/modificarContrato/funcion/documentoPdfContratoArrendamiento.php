...
<tr>
        ...
        $cadenaSql = $this->miSql->getCadenaSql('consultaPlantilla', array('tipo_contrato' => $contrato['tipo_contrato'], 'tipo_plantilla' => 'plantillaArrendamiento',  'fecha_vigencia' => $contrato['fecha_registro']));
