...
// Asociar el widget de validación al formulario
              $("#registrarElementoContrato").validationEngine({
     ...
     $( "#<?php echo $this->campoSeguro('tipo_registro')?>" ).change(function() {
            ...
            switch($("#<?php echo $this->campoSeguro('tipo_registro')?>").val())
            {
                ...
                case '1':
                    ...
                    $("#<?php echo $this->campoSeguro('tipo_consultas')?>").css('display','block');
                ...
                break;
                    ...
                    $("#<?php echo $this->campoSeguro('tipo_consultas')?>").css('display','none');
